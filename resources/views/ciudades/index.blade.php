...
<div class="flex flex-col">
    ...
    <div class="flex-col mt-20 shadow-lg">
        <h1 class="capitalize text-2xl font-bold text-gray-800 leading-tight text-center">Lista de Ciudades</h1>
      <table class="w-full">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td class="px-5 py-2 border-b-2 border-gray-200 text-center">{{ $ciudad->nombre }}</td>
                <td class="border-b-2 px-5 py-2 border-gray-200 flex justify-center items-center">
                    <div x-data="modalHandler()">
                        <x-primary-button @click="loadModalContent({{ $ciudad->id }})">
                            Ver
                        </x-primary-button>
                            <!-- Contenedor del modal -->
                        <div x-show="open" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                    ...
                    <div x-data="modalEdit()" class="mx-4">
                        <x-secondary-button @click="loadModalContent({{ $ciudad->id }})">
                            Editar
                        </x-secondary-button>
                            <!-- Contenedor del modal -->
                        <div x-show="open" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
